 ...
 * 
 * Date: 11-09-2025 12:59:59 GMT+0530
 */
 ...
 * @returns {Promise<any>} Resolves or rejects via callback.
 * 
 * @see https://github.com/jsvibe/fsmate/blob/HEAD/doc/fseek.md
 */
fsMate.fseek = async function(filePath, position) {
  this.fseekSync(filePath, position);
};
 ...
 * @returns {Promise<any>} Resolves or rejects via callback.
 * 
 * @see https://github.com/jsvibe/fsmate/blob/HEAD/doc/ftell.md
 */
fsMate.ftell = async function(filePath) {
  return Promise.resolve(this.ftellSync(filePath));
};
 ...
 * @returns {Promise<any>} Resolves or rejects via callback.
 * 
 * @see https://github.com/jsvibe/fsmate/blob/HEAD/doc/fgets.md
 */
fsMate.fgets = async function(filePath) {
 ...
 * @returns {Promise<any>} Resolves or rejects via callback.
 * 
 * @see https://github.com/jsvibe/fsmate/blob/HEAD/doc/fpassthru.md
 */
fsMate.fpassthru = async function(filePath) {
  let content = await this.readFile(filePath);
  let pos = this.ftellSync(filePath);
 ...
 * @returns {Promise<any>} Resolves or rejects via callback.
 * 
 * @see https://github.com/jsvibe/fsmate/blob/HEAD/doc/rewind.md
 */
fsMate.rewind = function(filePath) {
  return this.fseek(filePath, 0);
};
 ...
 * @returns {Promise<any>} Resolves or rejects via callback.
 * 
 * @see https://github.com/jsvibe/fsmate/blob/HEAD/doc/fwrite.md
 */
fsMate.fwrite = async function(filePath, content) {
 ...
 * @returns {Promise<any>} Resolves or rejects via callback.
 * 
 * @see https://github.com/jsvibe/fsmate/blob/HEAD/doc/fread.md
 */
fsMate.fread = async function(filePath, length) {
  if (typeof length !== 'number') {
    throw new Error('Cannot read file. Length value must be a number.');
  }
  ...
  let content = await this.fpassthru(filePath);
